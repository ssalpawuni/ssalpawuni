...
this post, we shall be considering a basic version of stochastic processes (Markov Chains) called **Random Walk**. The primary focus is to simulate data to illustrate what a simple random walk looks like.
